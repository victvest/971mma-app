-- Fix admin coach profile saves by replacing the invalid custom GUC key.
-- PostgreSQL custom setting names must use valid identifier parts; the old
-- "971mma.admin_coach_update" name fails before the coach update can run.
