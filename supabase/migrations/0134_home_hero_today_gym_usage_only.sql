-- Member home carousel source: today's Gym Usage only.
-- Schedule tab and coach mode are unaffected (they do not use this field for their UI).
...
begin
  ...
  from (
    ...
    where c.mindbody_class_id is not null
      ...
      and (c.starts_at at time zone 'Asia/Dubai')::date = v_today
      and (
