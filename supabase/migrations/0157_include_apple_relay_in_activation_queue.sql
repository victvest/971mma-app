-- 0157_include_apple_relay_in_activation_queue.sql
-- Allow members who registered with Apple Sign-In ("Hide My Email" / @privaterelay.appleid.com)
-- to be visible in the admin Activation Queue so staff can link them manually.

-- 1. Update admin_list_activation_requests
...
-- 2. Update admin_count_activation_requests
