...
import type { BeltRequirementItem, BeltRankItem, PromotionItem } from '@/types/domain';
...
export function mapCurriculumRanksToAscentStops(ranks: BeltRankItem[]): BeltPathCurriculumPreviewItem[] {
